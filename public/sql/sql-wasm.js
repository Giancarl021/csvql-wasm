    ...
    initSqlJsPromise = new Promise(function (resolveModule, reject) {
        ...
        e.onRuntimeInitialized = function () {
            ...
            f.prototype.create_aggregate = function (g, m) {
                ...
                if (!v)
                    throw (
                        'An aggregate function must have a step function in ' +
                        g
                    );
                var y = {};
                ...
                this.Na[m] = G;
                this.handleError(
                    rb(this.db, g, v.length - 1, 1, 0, 0, L, G, 0)
                );
                return this;
            };
            e.Database = f;
        ...
        function ec(a, b, c) {
            ...
            O = [
                ...
                1 <= +Math.abs(N)
                    ? 0 < N
                        ? (Math.min(+Math.floor(N / 4294967296), 4294967295) |
                              0) >>>
                          0
        ...
        function Lc(a, b, c) {
            function d(x) {
                return (x = x.toTimeString().match(/\(([A-Za-z ]+)\)$/))
                    ? x[1]
                    : 'GMT';
            }
        ...
        (function () {
            ...
            (function () {
                return Ia ||
                    ...
                    ? c(b)
                    : fetch(M, { credentials: 'same-origin' }).then(function (
                          f
                      ) {
        ...
        e._sqlite3_aggregate_context = function () {
            return (e._sqlite3_aggregate_context = e.asm.da).apply(
                null,
                arguments
            );
        };
        ...
        e._sqlite3_normalized_sql = function () {
            return (e._sqlite3_normalized_sql = e.asm.ra).apply(
                null,
                arguments
            );
        };
        ...
        e._sqlite3_create_function_v2 = function () {
            return (e._sqlite3_create_function_v2 = e.asm.wa).apply(
                null,
                arguments
            );
        };
        ...
        e._RegisterExtensionFunctions = function () {
            return (e._RegisterExtensionFunctions = e.asm.Ba).apply(
                null,
                arguments
            );
        };
